# course-builder (installed)

This is the installed Codex skill package for building study-ready course sites from chapter `.docx` files.

## Files
- `SKILL.md` - Codex skill behavior
- `assets/REQUIREMENTS.md` - reusable project requirements template
